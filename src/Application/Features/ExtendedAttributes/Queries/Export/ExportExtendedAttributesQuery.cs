...
using CleanArchitecture.Application.Specifications.ExtendedAttribute;
...
namespace CleanArchitecture.Application.Features.ExtendedAttributes.Queries.Export
{
