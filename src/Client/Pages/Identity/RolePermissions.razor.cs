...
//using CleanArchitecture.Client.Infrastructure.Managers.Identity.Roles;
//using CleanArchitecture.Client.Infrastructure.Mappings;
...
//namespace CleanArchitecture.Client.Pages.Identity
//{
