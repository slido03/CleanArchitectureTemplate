...
using CleanArchitecture.Client.Infrastructure.Authentication;
using CleanArchitecture.Client.Infrastructure.Managers;
using CleanArchitecture.Client.Infrastructure.Managers.ExtendedAttribute;
...
namespace CleanArchitecture.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        ...
        public static IServiceCollection AddExtendedAttributeManagers(this IServiceCollection services)
        {
            ...
            return services
                .AddTransient(typeof(IExtendedAttributeManager<Guid, Guid, Document, DocumentExtendedAttribute>), typeof(ExtendedAttributeManager<Guid, Guid, Document, DocumentExtendedAttribute>));
        }
